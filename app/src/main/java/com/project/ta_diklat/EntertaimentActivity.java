...
import com.project.adapter.NewsAdapter;
import com.project.api.NewsApi;
import com.project.model.ModelNews;
...
public class EntertaimentActivity extends AppCompatActivity implements NewsAdapter.onSelectData {
    ...
    List<com.project.model.ModelNews> modelNews = new ArrayList<>();
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < playerArray.length(); i++) {
                                ...
                                com.project.model.ModelNews dataApi = new com.project.model.ModelNews();
